    ...
    <div class="container d-flex justify-content-center">
        <form action="/MVC-Framework/Controller/UserController.php" id="loginForm" method="post" class="formLogin form-control">
            ...
            <div class="d-flex justify-content-center mt-1">
                    <span class="text-info"> New to here <a class="text-warning fst-bolder" href="<?= Url\UrlHelper::getViewUrl("registration.php")?>" role="button">Sign Up for Free</a></span>
            </div>
...
<style>
    ...
    body {
        background-image: url(<?=Url\UrlHelper::getImageUrl("background.jpg")?>);
